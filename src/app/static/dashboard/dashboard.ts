  ...
  protected readonly mbbsCountries = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1551867633-194f125bddfa?auto=format&fit=crop&w=900&q=85',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1513326738677-b964603b136d?auto=format&fit=crop&w=900&q=85',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1569531955323-33c6b2dca44b?auto=format&fit=crop&w=900&q=85',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1558588942-930faae5a389?auto=format&fit=crop&w=900&q=85',
      imageAlt: 'Modern city architecture in Kazakhstan'
    }
  ];

  protected readonly creativeTeamMembers = [
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a1.jpg', name: 'Patrick Stewart', role: 'Director of Medical Education' },
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a2.jpg', name: 'Alena Rosser', role: 'MBBS Admissions Advisor' },
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a3.jpg', name: 'Fletch Skinner', role: 'Clinical Education Mentor' },
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a4.jpg', name: 'Marc Spector', role: 'Medical Career Counsellor' },
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a5.jpg', name: 'Natalia Skinner', role: 'University Research Advisor' },
    { image: 'https://images.cnippet.dev/image/upload/v1770400411/a6.jpg', name: 'David Kim', role: 'Student Support Lead' }
  ];
