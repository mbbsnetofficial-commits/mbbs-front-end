...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, UcatAiChatModal, UcatAiInsightsModal],
...
export class UcatPreviousYear implements OnInit, OnDestroy {
  ...
  openAiChatForTestSession(testSessionId: string, defaultTitle = 'Previous Year Test Review'): void {
